 ...
 */
package com.example.zsid.uid.impl;

import com.example.zsid.uid.BitsAllocator;
import com.example.zsid.uid.UidGenerator;
import com.example.zsid.uid.exception.UidGenerateException;
import com.example.zsid.uid.utils.DateUtils;
import com.example.zsid.uid.worker.WorkerIdAssigner;
...
//    protected int seqBits = 13;
    ...
    public DefaultUidGenerator(Long workerIdAssignerWorkId) {
        // initialize bits allocator
        bitsAllocator = new BitsAllocator(timeBits, workerBits, seqBits);

        // initialize worker id
        workerId = workerIdAssignerWorkId;
    ...
    public String toBinaryString(long len, long number) {
        String numberStr = Long.toBinaryString(number);
        StringBuilder stringBuilder = new StringBuilder();
        long diffSize = len - numberStr.length();
